;;; ewal-doom-light-theme.el --- Dread the color of darkness -*- lexical-binding: t; -*-
...
(defun +doom--contrast (a b &optional ratio)
  (if (consp a)
      (cons (ct-tint-ratio (car-safe a) (or (car-safe b) b) (or ratio 8))
            (cdr a))
    (ct-tint-ratio (or (car-safe a) a) (or (car-safe b) b) (or ratio 8))))
...
(def-doom-theme ewal-doom-light
  ...
  ;; name        default   256       16
  ((bg         (ewal-doom-themes-get-color 'foreground +3))
   (bg-alt     (ewal-doom-themes-get-color 'foreground +3))
   ...
   (base6      (ewal-doom-themes-get-color 'foreground -3))
   (base7      (ewal-doom-themes-get-color 'foreground -4))
   (base8      (ewal-doom-themes-get-color 'black -1))
   (base9      (ewal-doom-themes-get-color 'foreground -2))
   (fg         (ewal-doom-themes-get-color 'black  0))
   (fg-alt     (ewal-doom-themes-get-color 'brightblack -2))
   ...
   (-modeline-pad
    (when ewal-doom-light-padded-modeline
      (if (integerp ewal-doom-light-padded-modeline) ewal-doom-light-padded-modeline 1)))
