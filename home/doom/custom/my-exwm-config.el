...
(defun my-autostart ()
  (unless my-autostart-done
    ...
    (exec "systemctl --user start stalonetray")
    ;; Use super as my leader key.
    (call-process "xmodmap" nil 0 nil "-e" "keycode 133 = Menu")
    (call-process "xmodmap" nil 0 nil "-e" "keycode 108 = Menu")
    ;; Don't repeat my leader key.
    (exec "xset -r 133")
    (exec "xset -r 108")
    ;; Don't repeat spacebar.
    (exec "xset -r 66")
    (call-process "xmodmap" nil 0 nil "-e" "clear mod4")
